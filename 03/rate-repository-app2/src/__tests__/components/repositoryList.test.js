...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent('21.8kStars');
      expect(firstRepositoryItem).toHaveTextContent('8kForks');
      ...
      expect(secondRepositoryItem).toHaveTextContent('1.7kStars');
